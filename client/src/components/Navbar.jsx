        ...
        <div className="hidden md:flex items-center gap-1">
          {user ? (
            <>
              ...
              <div className="relative" onMouseEnter={() => setRoomsOpen(true)} onMouseLeave={() => setRoomsOpen(false)}>
                <Link to="/rooms" className="text-white/75 no-underline text-sm font-medium px-3 py-2 rounded-md hover:text-white hover:bg-white/10 transition-colors font-sans inline-flex items-center gap-1">
                  Rooms
                ...
                {roomsOpen && (
                  <div className="absolute top-full left-0 w-44 bg-[#111] border border-[#2a2a2a] rounded-lg shadow-xl py-1">
                    <Link to="/rooms" className="block px-4 py-2 text-sm text-[#f5f5f5] no-underline hover:bg-white/10 transition-colors" onClick={() => setRoomsOpen(false)}>My Rooms</Link>
                    <Link to="/rooms/search" className="block px-4 py-2 text-sm text-[#f5f5f5] no-underline hover:bg-white/10 transition-colors" onClick={() => setRoomsOpen(false)}>Search</Link>
                    <Link to="/rooms/create" className="block px-4 py-2 text-sm text-[#f5f5f5] no-underline hover:bg-white/10 transition-colors" onClick={() => setRoomsOpen(false)}>Create</Link>
                    <Link to="/rooms/join" className="block px-4 py-2 text-sm text-[#f5f5f5] no-underline hover:bg-white/10 transition-colors" onClick={() => setRoomsOpen(false)}>Join by Code</Link>
                  </div>
                )}
              </div>
        ...
        <div className="md:hidden bg-[#000] border-t border-[#2a2a2a] px-4 py-3 flex flex-col gap-2">
          {user ? (
            <>
              ...
              <Link to="/rooms" className="text-[#f5f5f5] no-underline text-sm font-medium px-3 py-2 rounded-md hover:bg-white/10 transition-colors font-sans" onClick={() => setMenuOpen(false)}>Rooms</Link>
              <Link to="/rooms/search" className="text-[#f5f5f5] no-underline text-sm font-medium px-3 py-2 rounded-md hover:bg-white/10 transition-colors font-sans" onClick={() => setMenuOpen(false)}>Search</Link>
              <Link to="/rooms/create" className="text-[#f5f5f5] no-underline text-sm font-medium px-3 py-2 rounded-md hover:bg-white/10 transition-colors font-sans" onClick={() => setMenuOpen(false)}>Create</Link>
              <Link to="/rooms/join" className="text-[#f5f5f5] no-underline text-sm font-medium px-3 py-2 rounded-md hover:bg-white/10 transition-colors font-sans" onClick={() => setMenuOpen(false)}>Join by Code</Link>
